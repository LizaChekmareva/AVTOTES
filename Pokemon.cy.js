describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="email"]').type('nyelizavea@yandex.ru');  // вводим логин                
         cy.get('input[type="password"]').type('Fromki18');               // вводим пароль
         ...
         cy.get('.credit').type('2202869113632996');                     // вводим номер карты
